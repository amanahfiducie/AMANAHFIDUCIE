...
export const Route = createFileRoute("/service-conseil-successoral-islamique")({
  head: () => ({
    meta: [
      { title: "Conseil successoral islamique — Amanah Fiducie" },
      {
        name: "description",
        content:
  ...
  component: ServiceConseilSuccessoralIslamiquePage,
});
...
const publics = [
  {
    icon: UsersRound,
    title: "Familles confrontées à une succession",
    detail:
      "Lorsqu’un décès entraîne un partage de biens entre plusieurs héritiers et que la famille souhaite respecter les règles successorales islamiques.",
  },
  {
    icon: HeartHandshake,
    title: "Parents souhaitant anticiper leur transmission",
    detail:
      "Pour organiser leur patrimoine de leur vivant, réduire les tensions futures et préparer une transmission claire.",
  },
  {
    icon: Scale,
    title: "Veuves, héritiers et ayants droit",
    detail:
      "Qui souhaitent comprendre leurs droits, éviter les conflits et obtenir un accompagnement neutre.",
  },
  {
    icon: FileSignature,
    title: "Notaires et professionnels du droit",
    detail:
      "Dans les dossiers de succession complexes, sensibles ou impliquant des héritiers mineurs.",
  },
  {
    icon: Landmark,
    title: "Familles souhaitant structurer un waqf successoral",
    detail:
      "Lorsque le patrimoine doit être protégé sur le long terme et servir les descendants ou bénéficiaires selon des règles définies.",
  },
];
...
const missions: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    icon: FileSearch,
    title: "L’analyse de la situation successorale",
    desc: "Identification du défunt, des héritiers, des ayants droit, des biens et des éventuelles dettes.",
  },
  {
    icon: Calculator,
    title: "Le calcul des parts successorales",
    desc: "Détermination des droits de chaque héritier selon les règles du droit successoral islamique.",
  },
  {
    icon: HeartHandshake,
    title: "L’accompagnement au partage",
    desc: "Aide à la compréhension des parts, à la répartition des biens et à la recherche d’une solution équilibrée entre les héritiers.",
  },
  {
    icon: Layers,
    title: "La structuration de la transmission",
    desc: "Proposition de solutions adaptées : mandat de gestion, gestion temporaire des actifs indivis, waqf familial, ou organisation patrimoniale conforme.",
  },
  {
    icon: Baby,
    title: "La sécurisation des héritiers mineurs",
    desc: "Lorsque la succession implique des enfants mineurs, AMANAH FIDUCIE peut accompagner la protection et la gestion des biens qui leur reviennent.",
  },
];
...
const etapes: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    icon: UsersRound,
    title: "Étude de la situation familiale",
    desc: "Nous identifions les héritiers, les liens familiaux, la situation matrimoniale, les enfants mineurs éventuels et les personnes concernées par la succession.",
  },
  {
    icon: ClipboardList,
    title: "Inventaire du patrimoine",
    desc: "Les biens sont recensés : immobilier, terrains, liquidités, commerce, parts sociales, or, dettes, créances ou autres actifs familiaux.",
  },
  {
    icon: BookOpenCheck,
    title: "Analyse de conformité islamique",
    desc: "La situation est étudiée à la lumière des règles successorales islamiques afin de déterminer les héritiers éligibles et les parts de chacun.",
  },
  {
    icon: Calculator,
    title: "Calcul des parts successorales",
    desc: "Un calcul clair est réalisé pour préciser les droits de chaque héritier selon les principes du farāʾiḍ.",
  },
  {
    icon: Scale,
    title: "Recommandations de partage",
    desc: "AMANAH FIDUCIE propose une lecture structurée du partage, en tenant compte de la nature des biens, de leur indivision éventuelle et des besoins des bénéficiaires.",
  },
  {
    icon: Layers,
    title: "Structuration si nécessaire",
    desc: "Lorsque le patrimoine ne peut pas être partagé immédiatement, des solutions peuvent être proposées : gestion temporaire des biens, mandat fiduciaire, waqf familial ou organisation progressive de la transmission.",
  },
  {
    icon: FileBarChart,
    title: "Restitution d’un rapport clair",
    desc: "La famille reçoit une synthèse documentée comprenant les héritiers identifiés, les parts calculées, les recommandations et les options de structuration.",
  },
];
...
const prerequis: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    icon: UsersRound,
    title: "Identifier clairement les héritiers concernés",
    desc: "Époux ou épouse, enfants, parents, frères, sœurs ou autres ayants droit selon la situation.",
  },
  {
    icon: ClipboardList,
    title: "Disposer d’un minimum d’informations sur le patrimoine",
    desc: "Même si l’inventaire n’est pas encore complet, il faut pouvoir lister les principaux biens et dettes.",
  },
  {
    icon: FileSignature,
    title: "Avoir un cadre familial ou juridique clair",
    desc: "La mission peut être demandée par la famille, un représentant légal, un notaire ou toute partie légitime.",
  },
  {
    icon: BookOpenCheck,
...
const documents: {
...
}[] = [
  {
    ...
    items: [
      "Acte de décès, pièce d’identité du demandeur, actes de naissance, livret de famille ou documents équivalents.",
    ],
  },
  {
    icon: UsersRound,
    ...
    items: [
      "Liste des héritiers, liens de parenté, situation matrimoniale du défunt, informations sur les enfants mineurs ou ayants droit protégés.",
    ],
  },
  {
    icon: Building2,
    ...
    items: [
      "Titres fonciers, actes de propriété, relevés bancaires, documents commerciaux, parts sociales, biens mobiliers importants, or ou autres actifs.",
    ],
  },
  {
    icon: Receipt,
    ...
    items: [
      "Dettes éventuelles, créances, charges, impôts, engagements financiers, donations antérieures si elles existent.",
    ],
  },
  {
    icon: FileText,
    title: "Documents juridiques ou notariés",
    items: [
      "Acte de notoriété, certificat d’hérédité, jugement, mandat, testament éventuel ou documents déjà établis par un notaire.",
    ],
  },
];
...
function ServiceConseilSuccessoralIslamiquePage() {
              ...
              <article className="relative overflow-hidden rounded-3xl border border-border/70 bg-card p-6 sm:p-8 lg:p-11 shadow-elegant ring-1 ring-gold/12">
                <header className="border-l-[3px] border-gold pl-5 sm:pl-7">
                  ...
                  <p className="mt-4 max-w-3xl text-base text-muted-foreground leading-relaxed">
                    AMANAH FIDUCIE accompagne la famille dans&nbsp;:
                  </p>
                </header>
          ...
          <div className="mt-12 rounded-3xl border border-gold/25 bg-gradient-to-br from-cream/95 via-cream/80 to-background p-8 lg:p-10 shadow-card ring-1 ring-gold/15">
            <div className="flex flex-col items-center justify-between gap-6 text-center sm:flex-row sm:text-left">
              <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
                Un conseiller peut vous aider à structurer votre succession et à préparer les pièces
                selon votre dossier.
              </p>
